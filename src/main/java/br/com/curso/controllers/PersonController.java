...
public class PersonController {
	...
	@Operation(summary = "Finds all People", description = "Endpoint for Managing People",
			tags = {"People"},
			 responses = {
	...
	@CrossOrigin(origins = {"http//localhost:8080", "http//ruan.com.br"})
	...
	/**********não está sendo utilizado um PersonV2 ***************************
...
************************************************/
	...
	@Operation(summary = "Update a Person", 
			 description = "Update a Person by passing in a JSON, XML or YML",
			 tags = {"People"},
			 responses = {
	...
	@Operation(summary = "Delete a Person", 
			 description = "Delete a Person by passing in a JSON, XML or YML",
			 tags = {"People"},
			 responses = {
